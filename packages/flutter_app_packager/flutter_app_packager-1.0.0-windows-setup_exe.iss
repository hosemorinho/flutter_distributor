...
OutputDir=.
OutputBaseFilename=flutter_app_packager-1.0.0-windows-setup
Compression=lzma
...
[Files]
Source: "flutter_app_packager-1.0.0-windows-setup_exe\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
